...
- `/admin/content` now provides a read-only content inventory, structural diff, and publish-readiness scaffold over the current guide, FAQ, glossary, documents, and hub surfaces

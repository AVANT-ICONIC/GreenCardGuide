...
- `npm run validate:cloudflare` now checks the intentional Cloudflare Workers integration structure across package scripts, OpenNext/Wrangler config, deployment workflow trigger, runtime, install, and secret markers, and README deployment framing.
